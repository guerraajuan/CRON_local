<?php
    ...
    class Database{
        ...
        private $username = 'atm'; 
        private $password = 'amt2023#tsprsf'; 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function conectar($port , $host)
    {
        ...
        $socket = socket_create(AF_INET, SOCK_STREAM, SOL_TCP ) or die("Could not create socket\n");
            // connect to server
        $timeout = array('sec' => 15, 'usec' => 0);
        socket_set_option($socket, SOL_SOCKET, SO_RCVTIMEO, $timeout);
        
        try {
                $result = socket_connect($socket, $host, $port) or die("SIN CONEXION AL PUERTO\n");
        } catch (Exception $e) {
            // Manejar la excepción de tiempo de espera
            echo "Se ha producido un error de timeout en la conexion: " . $e->getMessage();
        }
        ...
        while (true) {
            ...
            try {
                ...
                if(!$result){
                    throw new Exception('Error al leer mensaje');
                }
